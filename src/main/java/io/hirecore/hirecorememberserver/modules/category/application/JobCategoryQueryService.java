 ...
 * {@link LoadJobCategoryHierarchyUseCase}, {@link LoadJobCategoryIdByCodeUseCase}) 를 한 클래스에서 구현합니다.</p>
 */
@Service
...
public class JobCategoryQueryService implements
    ...
    public List<JobCategoryNodeResponse> loadAllWithinDepth(Integer maxDepth) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<JobCategory> loadHierarchyFromLeaf(Long leafJobCategoryId) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Long loadIdByCode(String categoryCode) {
