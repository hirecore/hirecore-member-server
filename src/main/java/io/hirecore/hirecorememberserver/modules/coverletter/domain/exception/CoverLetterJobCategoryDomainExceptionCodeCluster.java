...
public class CoverLetterJobCategoryDomainExceptionCodeCluster {
    @Getter
    ...
    public enum HiddenDetailResponse implements DomainExceptionCode {
        ...
        JOB_CATEGORY_ID_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterJobCategory 도메인 객체 생성에서 jobCategoryId 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // IS_DELETED
        IS_DELETED_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterJobCategory 도메인 객체 생성에서 isDeleted 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // CONNECTED_AT
        CONNECTED_AT_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterJobCategory 도메인 객체 생성에서 connectedAt 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // USER_INPUT
        USER_INPUT_TOO_LONG(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterJobCategory 도메인 객체 생성에서 userInput 길이가 허용 한도를 초과했습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요.");
