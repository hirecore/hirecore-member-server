...
public class CoverLetterTagDomainExceptionCodeCluster {
    @Getter
    ...
    public enum HiddenDetailResponse implements DomainExceptionCode {
        ...
        ID_MISSING(
                ...
                "CoverLetterTag 도메인 객체 생성에서 id 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // COVER_LETTER_ID
        COVER_LETTER_ID_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterTag 도메인 객체 생성에서 coverLetterId 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // USER_INPUT_TAG
        USER_INPUT_TAG_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterTag 도메인 객체 생성에서 userInputTag 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // NORMALIZED_TAG
        NORMALIZED_TAG_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterTag 도메인 객체 생성에서 normalizedTag 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요."),

        // AUDITING_INFO
        AUDITING_INFO_MISSING(
                HttpStatus.INTERNAL_SERVER_ERROR,
                "CoverLetterTag 도메인 객체 생성에서 auditingInfo 필드가 누락되었습니다.",
                "서버에서 오류가 발생했습니다. 관리자에게 문의해주세요.");
