...
public class ResumeJpaEntity extends AbstractPersistableAggregateRoot<Long> {
    ...
    private ResumeJobCategoryJpaEntity resumeJobCategory;
    ...
    private ResumeContentJpaEntity resumeContent;
    ...
    @Builder.Default
    private List<ResumeTagJpaEntity> resumeTags = new ArrayList<>();
     ...
     */
    public void syncResumeContent(ResumeContentJpaEntity newContent) {
        this.resumeContent = newContent;
        if (newContent != null) {
            newContent.setResume(this);
        }
    }

    public void syncResumeJobCategory(ResumeJobCategoryJpaEntity newJobCategory) {
        this.resumeJobCategory = newJobCategory;
        if (newJobCategory != null) {
            newJobCategory.setResume(this);
        }
    }

    public void addResumeTag(ResumeTagJpaEntity tag) {
        this.resumeTags.add(tag);
        tag.attachResume(this);
    }
}
